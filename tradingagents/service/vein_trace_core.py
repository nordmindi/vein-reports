"""Vein platform shared trace core (vendored identically into each Python service).

Keep this file byte-identical across:
  - vein-signals/src/vein_trace_core.py
  - vein-reports/tradingagents/service/vein_trace_core.py
  - vein-aggregator/app/shared/vein_trace_core.py
  - vein-signals/platform/vein_trace_core.py  (canonical reference)

Service wrappers set DEFAULT_SERVICE and may add helpers (bind_trace_from_job, FastAPI middleware).
Run: python scripts/check_vein_trace_sync.py
"""
...
_request_id: ContextVar[str | None] = ContextVar("vein_trace_request_id", default=None)
_correlation_id: ContextVar[str | None] = ContextVar("vein_trace_correlation_id", default=None)
_service: ContextVar[str | None] = ContextVar("vein_trace_service", default=None)
_span: ContextVar[str | None] = ContextVar("vein_trace_span", default=None)
_job_id: ContextVar[str | None] = ContextVar("vein_trace_job_id", default=None)

# Overridden by service wrappers when importing.
DEFAULT_SERVICE = "vein-platform"
...
def log_event(level: str, event: str, **fields: Any) -> None:
    record = {
        ...
        "level": level.lower(),
        "event": event,
        "service": _service.get() or fields.pop("service", None) or DEFAULT_SERVICE,
        "requestId": _request_id.get(),
        "correlationId": _correlation_id.get(),
        "jobId": _job_id.get(),
        "span": _span.get(),
