...
def validate_postman_collection():
    ...
    required_items = [
        ...
        'Create Report Job - VEIN Context',
        'Create Report Job - Sector Target',
        'Create Report Job - Commodity Target',
        'Create Report Job - Missing Subject',
        'Create Report Job - Ticker And Target',
